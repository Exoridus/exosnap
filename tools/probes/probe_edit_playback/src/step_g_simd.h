...
// Step G: SIMD-vs-scalar variants of recorder_core::ConvertFullPlanarYuv420ToBgra
// (libs/recorder_core/src/yuv_to_bgra.cpp), for the 2026-08-01 investigation
...
// recorder_core::ConvertFullPlanarYuv420ToBgra, defined in its own
