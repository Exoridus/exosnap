...
LONG WINAPI MyUnhandledExceptionFilter(EXCEPTION_POINTERS* pExceptionInfo) {
    fprintf(stderr, "[probe] FATAL: unhandled exception 0x%08lX at address %p\n",
            static_cast<unsigned long>(pExceptionInfo->ExceptionRecord->ExceptionCode),
...
int main() {
    ...
    try {
        process_loopback_probe::Probe probe;
