...
void QuickThemeTokens::setAppearance(const QString& appearance_id, const QString& accent_id) {
    ...
    // The tray menu is NOT reached by this: on Windows it is a native popup
    // menu user32 paints from the system menu theme, which the application
    // sets through NativeMenuAppearance instead.
