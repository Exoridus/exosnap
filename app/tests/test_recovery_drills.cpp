...
TEST(RecoveryDrill, RecordingProcessKill_NonFinalizedPartialRepairsOrPreserves) {
    ...
    ASSERT_TRUE(WriteSyntheticMkv(artefact, recorder_core::VideoCodec::H264Nvenc, recorder_core::AudioCodec::Aac, 4.0));
...
TEST(RecoveryDrill, RemuxMp4Ordered_ValidMkvProducesPlayableMp4) {
    ...
    ASSERT_TRUE(WriteSyntheticMkv(artefact, recorder_core::VideoCodec::H264Nvenc, recorder_core::AudioCodec::Aac, 2.0));
...
TEST(RecoveryDrill, LiveRemuxMp4_NeverWritesTargetMidFlightThenPublishesAtomically) {
    ...
    ASSERT_TRUE(
        WriteSyntheticMkv(transient_q, recorder_core::VideoCodec::H264Nvenc, recorder_core::AudioCodec::Aac, 2.0));
