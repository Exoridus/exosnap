---
name: exo-research
description: Primary-source research and API behavior verification for exosnap. Use when hard API questions (NVENC, WASAPI, Media Foundation, Windows App SDK) need authoritative answers before implementation starts. Read and web-search only; no file edits unless explicitly asked. Cites official primary sources; stops if sources are unavailable.
