---
name: exo-builder
description: Bounded implementation from an approved brief for exosnap. Use when scope is precisely defined, architecture is settled, and an exo-architect brief is in hand. Handles CMake, probe code, docs, and mechanical implementation. Stops on first gate failure; does not expand scope.
tools: Read, Glob, Grep, WebFetch, Bash, Edit, Write
---
