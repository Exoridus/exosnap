---
name: exo-reviewer
description: Final PR review before commit or merge for exosnap. Scope compliance, diff review, and acceptance checklist. Use before committing or opening a PR. Read and diff only by default — does not silently fix while reviewing. Identifies unrelated files, missing validation, and architecture violations.
