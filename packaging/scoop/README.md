...
History: the ScoopInstaller/Extras submission (PR #18018) was declined because the project does not yet meet the Extras popularity criteria (~100 stars / 50 forks). Resubmit to Extras once those are met. Until then, the own bucket is the supported channel.
