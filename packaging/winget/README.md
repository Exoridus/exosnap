...
- **0.8.1** — prepared here on the first harvested MSI (ADRs 0036/0037; every MSI since ~0.2.0 had been missing the FFmpeg runtime DLLs and crashed on launch), never submitted.
