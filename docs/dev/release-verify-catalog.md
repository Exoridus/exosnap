...
Catalog version `317a2f0f80981992`. 28 scenarios, 28 with a migrated body, 11 required for promotion.
...
| REL-CAP-FSE-001 | capture | 3 | SemiAuto | HardwareLab | Standard | OperatorAssisted | gpu.d3d11 = true | exosnap, presentmon | yes | no | ADR 0051 |
| REL-AUD-DEGRADE-001 | audio-physical | 3 | ManualPhysical | HardwareLab | Standard | OperatorAssisted | device.audio.render.normal = bound | exosnap, wasapi, ffprobe | yes | no | ADR 0046; docs/release-checklist.md section 7 |
