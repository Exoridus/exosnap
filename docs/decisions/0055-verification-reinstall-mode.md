...
same manifest cannot change the answer. The updater window keeps the standard ExoSnap wordmark plus
its stable `Updater` role label without a title-bar status badge; its working lines say "reinstall",
