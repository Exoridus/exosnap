...
using exosnap::engine::ColorMetadata;
...
static ColorMetadata Hdr10ColorWithMastering() {
    ColorMetadata color;
    color.primaries = exosnap::engine::ColorPrimaries::Bt2020;
    color.transfer = exosnap::engine::TransferCharacteristics::SmpteSt2084;
    color.matrix = exosnap::engine::MatrixCoefficients::Bt2020Ncl;
...
TEST_F(RemuxerTest, Mp4Bt709FallbackSuppressedWhenMasteringPresent) {
    ...
    color.matrix = exosnap::engine::MatrixCoefficients::Unspecified;
