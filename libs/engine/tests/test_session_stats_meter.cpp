...
using exosnap::engine::MeterCallback;
using exosnap::engine::MeterSnapshot;
using exosnap::engine::SessionState;
using exosnap::engine::SessionStatsCollector;
using exosnap::engine::StatsCallback;
...
TEST(SessionStatsMeterCollectorTest, MeterCallback_FiresMoreFrequentlyThanStatsCallback) {
    ...
    state.stats_callback = [&](const exosnap::engine::SessionStats&) { ++stats_count; };
