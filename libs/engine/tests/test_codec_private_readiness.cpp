...
using exosnap::engine::CodecPrivateData;
...
TEST(CodecPrivateReadinessTest, CodecPrivateData_Reset_StartsNotReady) {
    ...
    for (bool track_ready : data.audio_track_ready) {
