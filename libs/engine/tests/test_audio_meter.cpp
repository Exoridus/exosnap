...
using exosnap::engine::ComputeRmsFromInt16;
using exosnap::engine::ComputeRmsLinear;
using exosnap::engine::kDbFloor;
using exosnap::engine::RmsToDbfs;
using exosnap::engine::RmsToMeter01;
