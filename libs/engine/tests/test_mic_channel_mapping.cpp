...
using exosnap::engine::mic_channel_detail::AutoModeState;
using exosnap::engine::mic_channel_detail::EffectiveAutoMode;
using exosnap::engine::mic_channel_detail::MapStereoFrameFloat32;
using exosnap::engine::mic_channel_detail::MapStereoFrameInt16;
using exosnap::engine::mic_channel_detail::ResolveAutoChannelMode;
using exosnap::engine::mic_channel_detail::UpdateAutoModeStateFloat32;
using exosnap::engine::mic_channel_detail::UpdateAutoModeStateInt16;
