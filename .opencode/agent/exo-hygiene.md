---
description: Formatting, branch hygiene, small CMake registration, docs-only mechanical updates, and git diff/stat/status reporting. Use ONLY for formatting or mechanical docs changes. Do not use for feature work.
mode: primary
